...
SteeringBehaviours.wander = function(agent, wanderFactor, params) {
  let maxSpeed = params.maxSpeed || agent.maxSpeed
  let wanderRadius = 1
  ...
  let desired = target.sub(agent.position).normalize().mult(maxSpeed)
  return desired
}
